  ...
  return (
    <form action={submit} className="mt-8 grid gap-5">
      ...
      <Select
        ...
        defaultValue={journey.skinArea.region}
      />
      <Select
        label="Lado"
        name="side"
        options={options.side}
        defaultValue={journey.skinArea.side}
      />
      <Select
        label="Contexto percebido"
        name="context"
        options={options.context}
        defaultValue={journey.context}
      />
      <Select
        label="Tempo percebido"
        name="approximateAge"
        options={options.approximateAge}
        defaultValue={journey.approximateAge}
      />
      <Select label="Objetivo" name="goal" options={options.goal} defaultValue={journey.goal} />
      {error && (
        <p role="alert" className="rounded-xl bg-clay/10 p-4 text-base text-clay">
          {error}
        </p>
      )}
